...
class __$$InitialCopyWithImpl<T, $Res>
    extends _$AppStatesCopyWithImpl<T, $Res, _$Initial<T>>
...
abstract class Initial<T> implements AppStates<T> {
...
class __$$LoadingCopyWithImpl<T, $Res>
    extends _$AppStatesCopyWithImpl<T, $Res, _$Loading<T>>
...
abstract class Loading<T> implements AppStates<T> {
...
class __$$EmptyCopyWithImpl<T, $Res>
    extends _$AppStatesCopyWithImpl<T, $Res, _$Empty<T>>
...
abstract class Empty<T> implements AppStates<T> {
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$AppStatesCopyWithImpl<T, $Res, _$Success<T>>
...
abstract class Success<T> implements AppStates<T> {
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$AppStatesCopyWithImpl<T, $Res, _$Error<T>>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'AppStates<$T>.error(message: $message)';
  }
...
abstract class Error<T> implements AppStates<T> {
